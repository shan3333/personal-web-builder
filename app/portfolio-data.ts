...
export const projects = [
  { title: "The Hague Appointment Alert", description: "A hosted monitoring service that checks municipality appointment availability and alerts users when suitable dates appear.", longDescription: "Built from a problem experienced first-hand and designed as an extensible service—not a one-off script.", technologies: ["TypeScript", "Node.js", "Playwright", "Telegram", "Google Cloud", "Codex"], highlights: ["Matches multiple services against customer-specific date preferences", "Real monitoring and simulation modes with automated testing and CI", "Continuously deployed for monitoring, with room to expand to more municipalities"], githubUrl: "https://github.com/shan3333/the-hague-appointment-checker", liveUrl: "", image: "", status: "Active build", featured: true, mark: "DH" },
